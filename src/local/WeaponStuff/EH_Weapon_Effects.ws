...
function ACS_Light_Attack_Trail()
{
	...
	{
		ACSGetCEntity('ACS_Dual_Wield_L_Sword_Steel').PlayEffectSingle('light_trail_fx');

		ACSGetCEntity('ACS_Dual_Wield_L_Sword_Steel').StopEffect('light_trail_fx');
	}

	if (ACSGetCEntity('ACS_Dual_Wield_L_Sword_Silver'))
	{
		ACSGetCEntity('ACS_Dual_Wield_L_Sword_Silver').PlayEffectSingle('light_trail_fx');

		ACSGetCEntity('ACS_Dual_Wield_L_Sword_Silver').StopEffect('light_trail_fx');
	}
}
...
function ACS_Heavy_Attack_Trail()
{
	...
	if (ACSGetCEntity('ACS_Dual_Wield_L_Sword_Steel'))
	{
		ACSGetCEntity('ACS_Dual_Wield_L_Sword_Steel').PlayEffectSingle('heavy_trail_fx');

		ACSGetCEntity('ACS_Dual_Wield_L_Sword_Steel').StopEffect('heavy_trail_fx');
	}

	if (ACSGetCEntity('ACS_Dual_Wield_L_Sword_Silver'))
	{
		ACSGetCEntity('ACS_Dual_Wield_L_Sword_Silver').PlayEffectSingle('heavy_trail_fx');

		ACSGetCEntity('ACS_Dual_Wield_L_Sword_Silver').StopEffect('heavy_trail_fx');
	}
}
